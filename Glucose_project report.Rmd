...
Linear regression between glyemia and weight:
Following this scatter plot, there is a horizontal linear relationships between these variables.
...
Linear regression between glyemia and choesterol:
As we can see, there is a horizontal linear regression.
```{r, echo=FALSE, include=TRUE}
glycemia <- glucose$glyhb
...
Here we see a slight positive linear regression.
```{r, echo=FALSE, include=TRUE}
glycemia <- glucose$glyhb
age <- glucose$age
